<x-layouts.dashboard title="Admin Dashboard">
    ...
    <div class="mt-8 bg-white rounded-xl shadow-sm border border-slate-100 p-6">
        ...
        <div class="mt-4 flex flex-wrap gap-4">
            ...
            <button class="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg text-sm transition-all">
                Add Teacher
            </button>

            <button class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg text-sm transition-all">
                Create Class
            </button>
        </div>
    </div>
